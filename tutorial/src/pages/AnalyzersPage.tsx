...
const failedGuessLines = [
	...
	{ text: "", delay: 200 },
	{
		text: "# Meanwhile, harness detected FastAPI + SQLAlchemy in 0.3s",
		...
		<DeepDiveLayout categoryId="analyzers">
			...
			<section className="mb-20">
				<ScrollReveal>
					...
					<p className="text-gray-400 mb-8 max-w-2xl">
						Without codebase analysis, AI agents spend their initial context window probing for
						languages, frameworks, and project structure -- burning tokens and time before doing any
						real work.
					</p>
				</ScrollReveal>
			...
			<section className="mb-20">
				<ScrollReveal>
					...
					<p className="text-gray-400 mb-8 max-w-2xl">
						Harness runs 14 targeted analyzers that inspect package files, AST structure, directory
						layout, and config files to build a complete project manifest in under a second.
					</p>
				</ScrollReveal>
