...
const layers: Layer[] = [
  { id: "ui", label: "UI / Presentation", description: "Views, templates, API routes, CLI handlers", idx: 0 },
  { id: "runtime", label: "Runtime / Orchestration", description: "Schedulers, workers, middleware, startup", idx: 1 },
  { id: "service", label: "Service / Business Logic", description: "Use cases, workflows, domain rules", idx: 2 },
  { id: "repo", label: "Repository / Data Access", description: "Database queries, external API clients, caches", idx: 3 },
  { id: "config", label: "Config / Settings", description: "Environment config, feature flags, constants", idx: 4 },
  { id: "types", label: "Types / Shared Models", description: "Data models, interfaces, enums, schemas", idx: 5 },
];
    ...
    <DeepDiveLayout categoryId="architecture">
      ...
      <section className="mb-20">
        <ScrollReveal>
          ...
          <p className="text-gray-400 mb-8 max-w-2xl">
            Without enforced boundaries, dependencies flow in every direction.
            Services import UI components, repositories call business logic,
            and the codebase becomes an untestable, unreviewable tangle.
          </p>
        </ScrollReveal>
      ...
      <section className="mb-20">
        <ScrollReveal>
          ...
          <p className="text-gray-400 mb-8 max-w-2xl">
            Harness generates a 6-layer architecture definition, linter rules,
            structural tests, and CI validation scripts. Every import is checked
            against the one-way dependency rule: layers may only import from
            layers below.
          </p>
        </ScrollReveal>
      ...
      <section className="mb-20">
        <ScrollReveal>
          ...
          <p className="text-gray-400 mb-8 max-w-2xl">
            Click any layer to see which imports are allowed (green) and which are
            forbidden (red). Each layer may only import from layers below it.
          </p>
        </ScrollReveal>
