...
| [.claude/commands/logging-convention.md](https://github.com/bowen31337/agent-harness-skills/blob/main/.claude/commands/logging-convention.md) | skill that regenerated this file |
| [.claude/commands/log-format-linter.md](https://github.com/bowen31337/agent-harness-skills/blob/main/.claude/commands/log-format-linter.md) | CI linter that validates against this spec |
