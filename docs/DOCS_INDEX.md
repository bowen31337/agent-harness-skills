...
| [docs/design-docs/README.md](design-docs/README.md) | Architectural Decision Records (ADR) directory |
| [docs/design-docs/adr/0001-adopt-playwright-for-browser-testing.md](design-docs/adr/0001-adopt-playwright-for-browser-testing.md) | ADR-0001: Playwright for browser testing |
...
| [docs/ERROR_HANDLING_RULES.md](ERROR_HANDLING_RULES.md) | Structured error model, GateResult patterns, severity levels |
...
| Document | Purpose |
|---|---|
| [docs/SPEC.md](SPEC.md) | Logging convention — five required fields, JSON Schema, adoption guide |
| [docs/HEALTH_CHECK_SPEC.md](HEALTH_CHECK_SPEC.md) | Health check endpoint contract — response format, polling protocol |
| [docs/health-check-endpoint-spec.md](health-check-endpoint-spec.md) | Extended health check spec with ADR context |
...
| Document | Purpose |
|---|---|
| [docs/plan-to-pr-convention.md](plan-to-pr-convention.md) | Plan-to-PR traceability: branch naming, PR title, commit trailers |
| [docs/harness-changelog.md](harness-changelog.md) | Harness changelog — version history |
...
| [docs/exec-plans/progress.md](exec-plans/progress.md) | Live execution plan progress log |
| [docs/exec-plans/debt.md](exec-plans/debt.md) | Technical debt backlog |
| [docs/exec-plans/perf.md](exec-plans/perf.md) | Performance improvement plan |
