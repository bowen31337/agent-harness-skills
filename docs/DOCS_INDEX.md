...
| Document | Purpose |
|---|---|
| [guides/agent-tool-design-guidelines.md](guides/agent-tool-design-guidelines.md) | Agent tool design best practices and model capability calibration |
| [guides/plan-to-pr-convention.md](guides/plan-to-pr-convention.md) | Plan-to-PR traceability: branch naming, PR title, commit trailers |
| [guides/gap-closure-plan.md](guides/gap-closure-plan.md) | Spec vs implementation gap closure report |
...
| Document | Purpose |
|---|---|
| [agents/browser.md](agents/browser.md) | Browser automation with AgentDriver and dom_snapshot |
| [agents/cli-commands.md](agents/cli-commands.md) | CLI commands reference (17 commands) |
| [agents/coordination.md](agents/coordination.md) | Multi-agent coordination patterns |
| [agents/gates.md](agents/gates.md) | Evaluation gates (pass/fail quality checks) |
| [agents/logging.md](agents/logging.md) | Structured logging (domain fields, trace-IDs) |
| [agents/skills.md](agents/skills.md) | Skills catalog (34 slash-commands) |
...
| Document | Purpose |
|---|---|
| [harness-changelog.md](harness-changelog.md) | Harness changelog — version history |
...
| [exec-plans/progress.md](exec-plans/progress.md) | Live execution plan progress log |
| [exec-plans/debt.md](exec-plans/debt.md) | Technical debt backlog |
| [exec-plans/perf.md](exec-plans/perf.md) | Performance improvement plan |
