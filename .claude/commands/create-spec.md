...
Supports two modes:
- **Greenfield**: building a new project from scratch → produces `spec/app_spec.txt`
...
features:
  # Generated by: claw-forge plan spec/app_spec.txt
```
...
Next steps:
  1. Review spec/app_spec.txt — add/remove features as needed
  2. Run: claw-forge plan spec/app_spec.txt
