...
head: 0e893bd
>>>>>>> feat/skill-invocatio-skill-registers-as-harness-evaluate-for
artifact: evaluation
...
||||||| 0e893bd
<!-- TODO: fill in EVALUATION.md content -->
=======
# Evaluation Report

> Last run: 2026-03-21 15:13:21Z  ·  Branch: feat/skill-invocatio-skill-registers-as-harness-evaluate-for  ·  SHA: 0e893bd
...
| Skipped | 6 |
| Blocking failures | 3 |
| Total violations | 529 |

## Gate Results

| Gate | Status | Duration | Failures |
|---|---|---|---|
| regression | ❌ FAILED | 2180 ms | 3 |
| coverage | ⏭ SKIPPED | 0 ms | 0 |
| security | ⏭ SKIPPED | 0 ms | 0 |
| performance | ⏭ SKIPPED | 0 ms | 0 |
| architecture | ⏭ SKIPPED | 0 ms | 0 |
| principles | ⏭ SKIPPED | 0 ms | 0 |
| docs_freshness | ✅ PASSED | 48 ms | 0 |
| types | ⏭ SKIPPED | 0 ms | 0 |
| lint | ❌ FAILED | 1520 ms | 526 |
>>>>>>> feat/skill-invocatio-skill-registers-as-harness-evaluate-for
